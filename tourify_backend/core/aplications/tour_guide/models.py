...
class Guide(models.Model):
    dni = models.IntegerField(max_length=150,null=False,blank=False,unique=True,primary_key=True)
    ...
    state = models.CharField(choices=STATE_GUIDE,blank=False,null=False)
